...
import { DeleteAdminsComponent } from "./delete-admins.component";
...
export function AdminsTableComponent(props) {
                                                        ...
                                                        <TableCell className={classes.selectTableCell}>
                                                            {
                                                                user.email == row.email ? (
                                                                    <IconButton
                                                                        aria-label="delete"
                                                                        disabled={true}
                                                                        onClick={() => deleteAdmin(row.id, row.displayName)}
                                                                    >
