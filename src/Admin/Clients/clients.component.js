...
import { ClientsTableComponent as ClientsDataTableComponent } from "./clients-table.component";
...
export default function User(props) {
    ...
    return (
        <RootStyle >
            ...
            <MainStyle>
                <Page title={"Dashboard: Clients | " + company}>
                    <Container >
                        ...
                        <ClientsDataTableComponent rows={rows} setRows={setRows} isLoadingRowsData={isLoadingRowsData} setIsLoadingRowsData={setIsLoadingRowsData} />
                    </Container>
                </Page>
            </MainStyle>
        </RootStyle>
